...
export default function AboutPage() {
	return (
		<div className="min-h-screen bg-background">
			...
			{/* Webinar Banner */}
			<div className="w-full bg-ultimate-purple text-white py-8 flex flex-col items-center justify-center">

				<Link
					href="https://example.com/webinar-register"
					target="_blank"
					rel="noopener noreferrer"
					className="inline-block bg-white text-ultimate-purple font-bold px-6 py-3 rounded-full shadow hover:bg-gray-100 transition"
				>
